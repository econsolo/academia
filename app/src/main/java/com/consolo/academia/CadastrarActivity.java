    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnResetPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CadastrarActivity.this, ResetarSenhaActivity.class));
            }
        });
                        ...
                        .addOnCompleteListener(CadastrarActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    startActivity(new Intent(CadastrarActivity.this,  ConsultarTreinoActivity.class));
                                    finish();
                                }
                            }
                        });
